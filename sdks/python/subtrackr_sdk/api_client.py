...
from subtrackr_sdk.configuration import Configuration
from subtrackr_sdk.api_response import ApiResponse, T as ApiResponseT
import subtrackr_sdk.models
from subtrackr_sdk import rest
from subtrackr_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(subtrackr_sdk.models, klass)
